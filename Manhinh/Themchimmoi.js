...
export default class Themchimmoi extends Component {
  ...
  gotoRegister (){
    ...
    let t = 'chim'+mi+''+sec+''+day+''+mon+''+yer
    var { navigation } = this.props;
    if(this.state.gioitinh == '' || this.state.nguongen == '' || this.state.tuoi == '' || this.state.giaban == '' || this.state.avatar == ''){
  ...
  //var aa = base64.decode('');
    axios.post("http://192.168.5.108/webmedia/ABB/themchim.php", 
      'idchim=' + t +
      '&gioitinh=' + this.state.gioitinh +
      '&imgchim=' + this.state.avatar +
      '&gen=' + this.state.nguongen +
    ...
    .then(function (response) {
      ...
      navigation.navigate("Quanlichim");
  ...
  render(){
    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.inputform}>
          ...
          <View style={styles.inputform}>
            ...
            <TextInput style={styles.txtinput}
              ...
              returnKeyType="next"
              onChangeText={(nguongen) => this.setState({nguongen})}/>
          </View>
        ...
        <View style={styles.inputform}>
            <Text style={styles.txt}>Tuổi</Text>
            <TextInput style={styles.txtinput}
              placeholderTextColor="rgba(30,30,30,0.3)"
              keyboardType="default"
              returnKeyType="next"
              onChangeText={(tuoi) => this.setState({tuoi})}/>
          </View>

          <View style={styles.inputform}>
            <Text style={styles.txt}>Giá bán</Text>
            <TextInput style={styles.txtinput}
              placeholderTextColor="rgba(30,30,30,0.3)"
              keyboardType="number-pad"
              returnKeyType="next"
